...
export default function TagModelUpdateForm(props) {
  const {
    id: idProp,
    tagModel: tagModelModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = tagModelRecord
      ? { ...initialValues, ...tagModelRecord }
      : initialValues;
  ...
  const [tagModelRecord, setTagModelRecord] = React.useState(tagModelModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(TagModel, idProp)
        : tagModelModelProp;
      setTagModelRecord(record);
    };
    queryData();
  }, [idProp, tagModelModelProp]);
  React.useEffect(resetStateValues, [tagModelRecord]);
  const validations = {
    title: [],
    tags: [],
    link: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            TagModel.copyOf(tagModelRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "TagModelUpdateForm")}
      {...rest}
    >
      <TextField
        label="Title"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || tagModelModelProp)}
