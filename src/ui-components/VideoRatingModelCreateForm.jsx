...
export default function VideoRatingModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIsViral(initialValues.isViral);
    ...
    setViralViews(initialValues.viralViews);
    setVideoActualViews(initialValues.videoActualViews);
    setViralCheckDateTime(initialValues.viralCheckDateTime);
    setErrors({});
  };
  const validations = {
    feedback: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new VideoRatingModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "VideoRatingModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Feedback"
