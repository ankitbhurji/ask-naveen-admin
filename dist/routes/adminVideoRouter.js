...
adminVideoRouter.get('/length', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const adminvideoRes = yield avModel.findDataLength();
...
adminVideoRouter.put('/delete', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
